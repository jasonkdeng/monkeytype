    ...
    <div className="App" tabIndex={-1}>
      ...
      <div className="container">
        <div className="timer">
          Time: {timeLeft}s
          <button 
            className="in-test-restart-btn" 
            onClick={handleRestart}
            aria-label="Restart test"
            tabIndex={0}
          >
            <svg className="restart-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
